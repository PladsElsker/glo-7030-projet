...
from preprocessing.video_resize_config import DATASET_SPLITS, DATASET_VIEWS, PATHS
...
def process_video_file(
    ...
    success = processor.resize_video(input_path, output_path, config)
    if success:
...
def process_directory(
    ...
    output_path = Path(clip_dir) / get_output_dir(config["width"])
...
def process_all_datasets(
    ...
    for dataset in get_clip_directories():
        ...
        process_directory(processor, dataset_path, config, extensions)
